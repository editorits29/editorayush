          ...
          <div className="flex gap-3 items-center">
            <div className="flex items-center">
              {[
                ...
                <div
                  key={index}
                  className="relative h-8 w-8 rounded-full border-2 border-white/80 overflow-hidden bg-gray-800"
              ...
              <div
                className="relative h-8 w-8 rounded-full border-2 border-white/80 bg-gradient-to-br from-pink-600 to-purple-700 flex items-center justify-center"
